...
<body>
    ...
    <div class="sredina">
        <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>">
            <input type="radio" name="velikost" value="A4" checked> <img src="slike/A4.jpg" style="max-width:300px;"><br>
            <input type="radio" name="velikost" value="A5"> <img src="slike/A5.jpg" style="max-width:300px;"><br>
